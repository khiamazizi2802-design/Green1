                    ...
                    >
                        ...
                        <div className="p-8 border-b border-white/5 flex justify-between items-center">
                            <div>
                                ...
                                <p className="text-[10px] font-black uppercase tracking-[0.4em] text-brand/60 mt-1 italic">
                        ...
                        <div className="p-6 border-t border-white/5 space-y-3">
                            ...
                            <button className="w-full p-4 rounded-2xl bg-red-500/5 border border-red-500/10 text-red-500 font-black uppercase tracking-widest text-xs flex items-center justify-center gap-2 hover:bg-red-500/10 transition-all group">
